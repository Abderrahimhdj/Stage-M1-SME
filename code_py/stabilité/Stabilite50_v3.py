...
for i in range(0):
    ...
    f.write('    <questiontext format="html"><text>Soit \\(H(p) = \\frac{1}{p+' + str(a) + '}\\). Ce systeme est-il stable ?</text></questiontext>\n')
...
for i in range(0):
    ...
    f.write('    <shuffleanswers>1</shuffleanswers>\n')
    f.write('    <questiontext format="html"><text>Soit \\(H(p) = \\frac{1}{p^2+' + str(a) + 'p+' + str(b) + '}\\). Ce systeme est-il stable ?</text></questiontext>\n')
    f.write('    <answer fraction="100"><text>' + bonne + '</text></answer>\n')
    f.write('    <answer fraction="0"><text>' + mauvaise + '</text></answer>\n')
    f.write('    <answer fraction="0"><text>On ne peut pas savoir</text></answer>\n')
    f.write('    <answer fraction="0"><text>Oui, car le gain est positif</text></answer>\n')
...
for i in range(1):
    ...
    f.write('    <shuffleanswers>1</shuffleanswers>\n')
    f.write('    <questiontext format="html"><text>Soit \\(H(p) = \\frac{1}{p^3+' + str(a) + 'p^2+' + str(b) + 'p+' + str(c) + '}\\). Ce systeme est-il stable ?</text></questiontext>\n')
    f.write('    <answer fraction="100"><text>' + bonne + '</text></answer>\n')
    f.write('    <answer fraction="0"><text>' + mauvaise + '</text></answer>\n')
    f.write('    <answer fraction="0"><text>On ne peut pas savoir</text></answer>\n')
    f.write('    <answer fraction="0"><text>Oui, car le gain est positif</text></answer>\n')
...
for i in range(0):
    ...
    f.write('    <shuffleanswers>1</shuffleanswers>\n')
    f.write('    <questiontext format="html"><text>Soit \\(H(p) = \\frac{1}{p^4+' + str(a) + 'p^3+' + str(b) + 'p^2+' + str(c) + 'p+' + str(d) + '}\\). Ce systeme est-il stable ?</text></questiontext>\n')
    f.write('    <answer fraction="100"><text>' + bonne + '</text></answer>\n')
    f.write('    <answer fraction="0"><text>' + mauvaise + '</text></answer>\n')
    f.write('    <answer fraction="0"><text>On ne peut pas savoir</text></answer>\n')
    f.write('    <answer fraction="0"><text>Oui, car le gain est positif</text></answer>\n')
